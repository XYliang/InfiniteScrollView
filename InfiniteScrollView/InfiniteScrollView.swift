...
//    var titles:NSArray = ["title1","title2","title3","title4","title5"]
     ...
     */
    init(frame: CGRect, images:[UIImage], timeInterval:Double, titles: [String]) {
     ...
     */
    init(frame: CGRect, images:[UIImage], timeInterval:Double, tapItemClosure:TapItemClosure, titles: [String]) {
        super.init(frame: frame)
        self.titles = titles
    ...
    /**
     ...
     - parameter timeInterval:    循环时间
     */
    init(frame: CGRect, imageURLStrings:[String], timeInterval:Double, titles: [String]) {
        super.init(frame: frame)
        self.titles = titles
        scrollView = UIScrollView(frame: CGRectMake(0,0,frame.size.width,frame.size.height))
    ...
    /**
     ...
     - parameter tapItemClosure  :closure实现点击事件
     */
    init(frame: CGRect, imageURLStrings:[String], timeInterval:Double, tapItemClosure:TapItemClosure, titles: [String]) {
        super.init(frame: frame)
        self.titles = titles
        self.tapItemClosure = tapItemClosure
        scrollView = UIScrollView(frame: CGRectMake(0,0,frame.size.width,frame.size.height))
    ...
    /**
     ...
     - parameter timeInterval:    循环时间
     */
    init(frame: CGRect, imageURLStrings:[String], placeholderImage:UIImage, timeInterval:Double, titles: [String]) {
        super.init(frame: frame)
        self.titles = titles
        scrollView = UIScrollView(frame: CGRectMake(0,0,frame.size.width,frame.size.height))
    ...
    /**
     ...
     - parameter tapItemClosure  :closure实现点击事件
     */
    init(frame: CGRect, imageURLStrings:[String], placeholderImage:UIImage, timeInterval:Double, tapItemClosure:TapItemClosure, titles: [String]) {
        super.init(frame: frame)
        self.titles = titles
        self.tapItemClosure = tapItemClosure
        scrollView = UIScrollView(frame: CGRectMake(0,0,frame.size.width,frame.size.height))
...
@objc
public protocol InfiniteScrollViewDelegate {
